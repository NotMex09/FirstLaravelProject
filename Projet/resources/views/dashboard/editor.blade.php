...
.sidebar ul li a:hover {
    background-color:rgb(102, 125, 171);
}
...
<div class="dashboard-container">
    ...
    <div class="sidebar">
        <h2>Dashboard</h2>
        <ul>
            <li><a href="javascript:void(0);" data-section="editor-section" onclick="showContent('editor-section', event)">Dashboard</a></li>
...
<li><a href="javascript:void(0);" data-section="Proposed-articles-list" onclick="showContent('Proposed-articles-list', event)">Proposed Articles</a></li>
<li><a href="javascript:void(0);" data-section="articles-list" onclick="showContent('articles-list', event)">Published articles</a></li>
<li><a href="javascript:void(0);" data-section="users-list" onclick="showContent('users-list', event)">All Users</a></li>
<li><a href="javascript:void(0);" data-section="conversations-list" onclick="showContent('conversations-list', event)">All comments</a></li>
<li><a href="javascript:void(0);" data-section="all-ratings" onclick="showContent('all-ratings', event)">All Ratings</a></li>
...
<li>
    ...
    <div class="main-content">
       ...
       <!-- Editor Dashboard -->
<div id="editor-section" class="">
    <h1>Welcome back, Editor {{ Auth::user()->name }}!</h1>
    <h2>Dashboard</h2>
    ...
    <div class="statistics">
        ...
        <div class="statistics-item" style="background-color:#dc3545;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('articles.destroy', $article->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this article?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" style="background-color:#dc3545;height:43px;">Delete</button>
                            </form>
                        </td>
                    </tr>
                @endif
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->role }}</td>
                            <td>
                                <a href="{{ route('users.edit-role', $user->id) }}" class="btn btn-edit">Edit Role</a>
                                <form action="{{ route('users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" style="background-color:#dc3545;width:97px;">Delete</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
...
<!--All ratings section-->
<div id="all-ratings" class="dashboard-section" style="display: none;">
    <h3>All Ratings</h3>
    <table class="styled-table">
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($allRatings as $rating)
                <tr>
                    ...
                    <td class="ban">{{ $rating->article->theme->name ?? 'No Theme' }}</td>
                    <td>
                        @for ($i = 1; $i <= 5; $i++)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // If the page has a hash, scroll to that section
        if (window.location.hash) {
            const targetId = window.location.hash.substring(1); // Remove the '#' part
            showContent(targetId);  // Show the section related to the hash
        }
    });
