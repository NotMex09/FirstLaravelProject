...
<div class="dashboard-container">
    ...
    <div class="sidebar">
        <h2>Dashboard</h2>
        <ul>
            <li><a href="#editor-section" onclick="showContent('editor-section')">Dashboard</a></li>
            <li><a href="#Proposed-articles-list" onclick="showContent('Proposed-articles-list')">Proposed Articles</a></li>
            <li><a href="#articles-list" onclick="showContent('articles-list')">Published articles</a></li>
            <li><a href="#users-list" onclick="showContent('users-list')">All Users</a></li>
            <li><a href="#conversations-list" onclick="showContent('conversations-list')">All comments</a></li>
